...
#jsonで保存
kunimi[2].to_json('KunimiForcast.json',force_ascii=False)
...
#jsonで保存
nakatu[2].to_json('NakatuForcast.json',force_ascii=False)
...
#jsonで保存
bungotakada[2].to_json('BungotakadaForcast.json',force_ascii=False)
...
#jsonで保存
kituki[2].to_json('KitukiForcast.json',force_ascii=False)
...
#jsonで保存
innai[2].to_json('InnaiForcast.json',force_ascii=False)
...
#jsonで保存
kusu[2].to_json('KusuForcast.json',force_ascii=False)
...
#jsonで保存
yuhuin[2].to_json('YuhuinForcast.json',force_ascii=False)
...
#jsonで保存
taketa[2].to_json('TaketaForcast.json',force_ascii=False)
...
#jsonで保存
inukai[2].to_json('InukaiForcast.json',force_ascii=False)
...
#jsonで保存
ume[2].to_json('UmeForcast.json',force_ascii=False)
...
#jsonで保存
saiki[2].to_json('SaikiForcast.json',force_ascii=False)
...
#jsonで保存
kamae[2].to_json('kamaeForcast.json',force_ascii=False)
